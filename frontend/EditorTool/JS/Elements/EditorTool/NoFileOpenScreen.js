...
export class NoFileOpenScreen extends HTMLElement {
  ...
  init() {
    ...
    css_link.href = "../EditorTool/CSS/Elements/NoFileOpenScreen.css";
    ...
    button_container.append(
      this.create_sprite_file_button,
      this.create_map_file_button
    );

    this.append(message, button_container);
  }
